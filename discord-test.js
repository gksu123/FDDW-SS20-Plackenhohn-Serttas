...
/*        rl.question('Bitte geben Sie ein Startort ein: ', (ans2) => {
 ...
 //    if(msgArray[0] === '/subscribe' || msgArray[0] === '/abonnieren' || msgArray[0] === '/channel'){
       ...
       channel.publish(exchange, daten.Startort, Buffer.from(daten.Startort));
       ...
       /*    console.log('');
           ...
           channel.assertQueue('', {
             ...
             channel.bindQueue(q.queue, exchange1, daten.Startort);
             
             channel.publish(exchange1, daten.Startort, Buffer.from(daten.Startort));
